    ...
    <div className="fixed inset-0 z-[100] bg-black/80 backdrop-blur-sm flex items-center justify-center p-6">
      <div className="bg-[#F5F5F5] rounded-3xl p-6 max-w-sm w-full border border-black/10 animate-slideUp">
        ...
        <p className="text-[#6B7280] text-center mb-6">
          Per la migliore esperienza e per installare l'app sulla Home, apri Myunionpaytest.it con Google Chrome.
        </p>
        ...
        <div className="mt-6 p-4 bg-white rounded-xl">
          <p className="text-xs text-[#6B7280] text-center">
            ...
            Con Chrome puoi installare Myunionpaytest.it come app e ricevere notifiche push
          </p>
        </div>
      </div>
    </div>
