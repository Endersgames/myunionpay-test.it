...
export default function MerchantDashboardPage() {
  ...
  const handleMenuScan = async (e) => {
    ...
    try {
      ...
      toast.success(result.message || `${result.items_count} piatti estratti! Costo: ${result.cost_up} UP`);
      const walletData = await walletAPI.getWallet();
      setWallet(walletData);
    } catch (err) {
          ...
          <div className="bg-[#F5F5F5] rounded-2xl p-5 border border-black/5 mb-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-[#6B7280]">Carica e MYU estrae i dati aziendali</p>
              </div>
            </div>
              ...
              >
                {visuraUploading ? (
                  <div className="text-center">
                    ...
                    <p className="text-sm text-[#2B7AB8] font-medium">MYU sta analizzando la visura...</p>
                  </div>
                ) : (
                  <div className="text-center">
                    ...
                    <p className="text-xs text-[#6B7280] mt-1">MYU estrarrà automaticamente i dati</p>
                  </div>
                )}
                <input
                  ref={visuraRef}
          ...
          <div className="bg-gradient-to-br from-[#E85A24]/5 to-[#E85A24]/10 rounded-2xl p-5 border border-[#E85A24]/20 mb-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-[#6B7280]">Foto del menu → MYU estrae piatti</p>
              </div>
            ...
            <div className="bg-white/80 rounded-xl p-4 mb-4">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-[#6B7280] space-y-1">
                  <p>Scatta una foto del tuo menu cartaceo. MYU:</p>
            ...
            >
              {menuScanning ? (
                <div className="text-center">
                  ...
                  <p className="text-sm text-[#E85A24] font-medium">MYU sta analizzando il menu...</p>
              ...
              <div className="mt-4 bg-white/80 rounded-xl p-4">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-semibold text-[#1A1A1A]">
                      {scanResult.items_count} piatti aggiunti
                    </span>
                  </div>
                ...
                {scanResult.duplicate_count > 0 && (
                  <p className="text-xs text-[#6B7280] mb-3">
                    {scanResult.duplicate_count} piatti erano gia presenti e sono stati saltati.
                  </p>
                )}
