  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.referral_code) {
        toast.success(
          `Bonus referral applicato! +${referredBonus.toFixed(2)} UP per te e +${referrerBonus.toFixed(2)} UP per chi ti ha invitato`
        );
      }
    ...
    <div className="min-h-screen bg-white px-6 py-8">
      ...
      <div className="relative z-10 max-w-md mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-[#6B7280]">Unisciti a myUup.com in pochi secondi</p>
        </div>
