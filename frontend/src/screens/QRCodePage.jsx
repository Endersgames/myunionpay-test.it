...
import { ArrowLeft, Copy, Share2, Users, Wallet } from "lucide-react";
    ...
    <div className="min-h-screen bg-white pb-safe">
      ...
      <div className="px-6 py-6 flex flex-col items-center">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-[#6B7280]">Codice personale per pagamenti e inviti</p>
        </div>
        ...
        <div className="mt-8 w-full max-w-sm space-y-4">
          ...
          <p className="text-sm text-[#6B7280] mb-3">
              Chi scansiona e non ha ancora un account verra guidato alla <span className="text-[#E85A24] font-semibold">registrazione con il tuo referral</span>, poi potra mettere myUup.com in Home con un tap.
          </p>
            <div className="bg-white rounded-xl p-3 space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-sm text-[#6B7280]">Presentante</span>
                <span className="font-mono font-bold text-[#E85A24]">+{referrerBonus.toFixed(2)} UP</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-[#6B7280]">Nuovo utente</span>
                <span className="font-mono font-bold text-[#2B7AB8]">+{referredBonus.toFixed(2)} UP</span>
              </div>
            </div>
          </div>
        </div>
