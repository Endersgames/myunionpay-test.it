      ...
      <div className="px-6 py-4">
        {notifications.length === 0 ? (
          <div className="bg-[#F5F5F5] rounded-2xl p-8 text-center">
            ...
            <p className="text-[#6B7280]">Nessuna notifica</p>
          ...
          <div className="space-y-3">
            {notifications.map((notif, index) => (
              <div
                ...
                className={`bg-[#F5F5F5] rounded-xl p-4 border transition-colors cursor-pointer animate-slideUp ${
                  notif.is_read ? 'border-black/5' : 'border-[#2B7AB8]/50'
                }`}
              ...
              >
                <div className="flex items-start gap-3">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0 ${
                    ...
                    <Store className={`w-5 h-5 ${notif.is_read ? 'text-[#6B7280]' : 'text-[#2B7AB8]'}`} />
                  </div>
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-[#6B7280] mt-1 line-clamp-2">{notif.message}</p>
