    ...
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      <div className="relative z-10 px-6 py-12 max-w-lg mx-auto">
        ...
        {showInstall && !isStandalone && (
          ...
          >
            <div className="flex items-center gap-3 flex-1">
              ...
              <div>
                <p className="font-semibold">Installa Myunionpaytest.it</p>
        ...
        <p className="text-center text-[#6B7280] text-sm mt-12">
          Unisciti a migliaia di utenti che usano Myunionpaytest.it ogni giorno
        </p>
      </div>
      ...
      <Dialog open={showInstructions} onOpenChange={setShowInstructions}>
        <DialogContent className="bg-white border-black/10 text-[#1A1A1A] max-w-sm mx-4">
          <DialogHeader>
            <DialogTitle className="font-heading text-xl">Installa Myunionpaytest.it</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 py-4">
            {isIOS ? (
              <>
                <p className="text-[#6B7280]">Per installare Myunionpaytest.it su iPhone/iPad:</p>
              ...
              <>
                <p className="text-[#6B7280]">Per installare Myunionpaytest.it:</p>
                <div className="space-y-3">
                  <div className="flex items-center gap-3 bg-[#F5F5F5] p-3 rounded-xl">
                    <div className="w-10 h-10 rounded-full bg-[#2B7AB8]/10 flex items-center justify-center">
