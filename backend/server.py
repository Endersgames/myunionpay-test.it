...
from routes.admin_myu_training import router as admin_myu_training_router
...
from routes.merchant_ai import router as merchant_ai_router
...
api_router.include_router(admin_myu_training_router)
api_router.include_router(admin_content_router)
api_router.include_router(admin_features_router)
api_router.include_router(merchant_ai_router)
...
async def startup_event():
    if os.environ.get("ENABLE_STARTUP_SEED", "true").lower() == "true":
